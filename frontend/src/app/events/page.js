        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 text-white">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24" dir={isRTL ? 'rtl' : 'ltr'}>
            <div className={`text-center ${isRTL ? 'md:text-right' : ''}`}>
              ...
              <p className={`text-lg sm:text-xl md:text-2xl text-green-100 max-w-4xl mb-12 leading-relaxed ${isRTL ? 'font-arabic mx-0' : 'mx-auto'}`}>
                {getTranslation(language, 'events.subtitle')}
              </p>
            </div>
            
            {/* Quick Stats */}
            <div className={`grid grid-cols-2 md:grid-cols-4 gap-6 ${isRTL ? 'text-right' : 'text-center'}`} dir={isRTL ? 'rtl' : 'ltr'}>
            ...
            <section className="mb-12 md:mb-20">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="lg:row-span-2 group">
                  <Card className="bg-gradient-to-br from-white to-gray-50 h-full flex flex-col" hover>
                    {featuredEvents[0]?.image ? (
                      ...
                      <div className="relative overflow-hidden rounded-t-2xl">
                        <div className="aspect-[4/3] bg-gradient-to-br from-green-100 via-emerald-100 to-green-200 flex items-center justify-center">
                          <div className="text-center">
                            <TrophyIcon className="w-16 h-16 text-green-600 mx-auto mb-3" />
                            <p className={`text-green-700 font-bold text-lg ${isRTL ? 'font-arabic' : ''}`}>
                    ...
                    <div className={`p-8 flex-1 flex flex-col ${isRTL ? 'text-right' : 'text-left'}`} dir={isRTL ? 'rtl' : 'ltr'}>
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <div className={`flex items-center ${isRTL ? 'flex-row-reverse' : ''}`}>
                        <TicketIcon className={`w-5 h-5 text-green-600 ${isRTL ? 'ml-3' : 'mr-3'}`} />
                        <span className={`text-gray-700 font-medium ${isRTL ? 'font-arabic' : ''}`}>
                          {featuredEvents[0]?.is_free ? getTranslation(language, 'events.free') : `$${featuredEvents[0]?.ticket_price}`}
                        </span>
                      </div>
                    </div>
                  ...
                  {featuredEvents.slice(1, 3).map((event) => {
                    ...
                    return (
                      <div key={event.id} className="group">
                        <Card hover className="bg-white border border-gray-200 h-full">
                          <div className={`flex p-5 h-full ${isRTL ? 'flex-row-reverse space-x-reverse space-x-4' : 'space-x-4'}`} dir={isRTL ? 'rtl' : 'ltr'}>
                            {event.image ? (
                              ...
                              <div className="w-20 h-16 flex-shrink-0 bg-gradient-to-br from-green-100 to-emerald-200 rounded-lg flex items-center justify-center">
                            ...
                            <div className={`flex-1 min-w-0 flex flex-col ${isRTL ? 'text-right' : 'text-left'}`}>
                              ...
                              <div className={`flex items-center text-xs text-gray-500 mt-auto ${isRTL ? 'flex-row-reverse space-x-reverse space-x-3' : 'space-x-3'}`}>
                                ...
                                <div className={`flex items-center ${isRTL ? 'flex-row-reverse' : ''}`}>
                                  <MapPinIcon className={`w-3 h-3 ${isRTL ? 'ml-1' : 'mr-1'}`} />
                                  <span className={isRTL ? 'font-arabic' : ''}>{event.venue_city}</span>
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <>
                      ...
                      <div key={event.id} className="group h-full">
                        <Card hover className="bg-white border-0 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 h-full flex flex-col">
                          {event.image ? (
                            ...
                            <div className="relative overflow-hidden rounded-t-2xl">
                              <div className="aspect-video bg-gradient-to-br from-green-100 via-emerald-100 to-green-200 flex items-center justify-center">
                                <div className="text-center">
                                  <CalendarIcon className="w-12 h-12 text-green-600 mx-auto mb-2" />
                                  <p className={`text-green-700 font-semibold ${isRTL ? 'font-arabic' : ''}`}>
                          ...
                          <div className={`p-5 flex-1 flex flex-col ${isRTL ? 'text-right' : 'text-left'}`} dir={isRTL ? 'rtl' : 'ltr'}>
              ...
              {pagination && pagination.totalPages > 1 && (
                <section className="flex justify-center mt-12 md:mt-20">
                  <div className="bg-white rounded-3xl shadow-xl p-6 md:p-8" dir={isRTL ? 'rtl' : 'ltr'}>
              ...
              {events.length === 0 && (
                <div className="col-span-full">
                  <div className={`bg-white rounded-3xl shadow-xl p-12 md:p-20 ${isRTL ? 'text-right' : 'text-center'}`} dir={isRTL ? 'rtl' : 'ltr'}>
