          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                <div className="group relative bg-white/90 backdrop-blur-xl rounded-[2rem] p-10 lg:p-12 border border-gray-200 hover:border-gray-300 transition-all duration-700 transform hover:-translate-y-4 hover:scale-[1.02] h-full flex flex-col overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="w-24 h-24 lg:w-28 lg:h-28 bg-gradient-to-br from-indigo-100 via-indigo-200 to-purple-200 rounded-3xl flex items-center justify-center mx-auto mb-10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 border border-gray-200">
                ...
                <div className="group relative bg-white/90 backdrop-blur-xl rounded-[2rem] p-10 lg:p-12 border border-gray-200 hover:border-gray-300 transition-all duration-700 transform hover:-translate-y-4 hover:scale-[1.02] h-full flex flex-col overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="w-24 h-24 lg:w-28 lg:h-28 bg-gradient-to-br from-purple-100 via-purple-200 to-pink-200 rounded-3xl flex items-center justify-center mx-auto mb-10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 border border-gray-200">
                ...
                <div className="group relative bg-white/90 backdrop-blur-xl rounded-[2rem] p-10 lg:p-12 border border-gray-200 hover:border-gray-300 transition-all duration-700 transform hover:-translate-y-4 hover:scale-[1.02] h-full flex flex-col overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="w-24 h-24 lg:w-28 lg:h-28 bg-gradient-to-br from-pink-100 via-pink-200 to-indigo-200 rounded-3xl flex items-center justify-center mx-auto mb-10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 border border-gray-200">
